...
var fetch_1 = __webpack_require__(11);
var fetch_svg_1 = __webpack_require__(12);
var embed_svg_1 = __webpack_require__(13);
var embed_comment_1 = __webpack_require__(14);
var PaperView = /** @class */ (function () {
    ...
    PaperView.prototype.load = function () {
        ...
        fetch_1.fetchURL(this.options.url + "/info.json", 'json').then(function (info) {
            ...
            for (var i = 0; i < info.numpages; i++) {
                ...
                page.setAttribute('style', "width:" + scale_1.px(info.dimensions.width, scaling) + ";height:" + scale_1.px(info.dimensions.height, scaling));
                _this.pages.push(page);
                pagesLoaded.push(fetch_svg_1.fetchSVG(_this.options.url + "/page-" + (i + 1) + ".svg"));
            ...
            //     }
            // })
            Promise.all(pagesLoaded).then(function (res) {
                for (var i = 0; i < info.numpages; i++) {
                    var svgDoc = res[i];
                    var page = _this.pages[i];
                    _this.doc.appendChild(page);
                    embed_svg_1.embedSVG(page, svgDoc);
                    _this.PAGES_DIMS[i] = { width: (page.offsetWidth), height: page.offsetHeight, offsetTop: ((i + 1) * page.offsetHeight) - page.offsetHeight };
                }
                ...
                _this.enabledTextSelectionListener();
                _this.loadComments();
    ...
    PaperView.prototype.loadComments = function () {
        ...
        for (var i in comments) {
            ...
            var page = this.pages[comment.numPage];
            embed_comment_1.embedComment(page, comment, this.VIEWPORT_DIM.height);
    ...
    PaperView.prototype.getCurrentPageNum = function () {
        ...
        var pageHeightTotal = 0, pageNum = 0;
        for (var i in this.PAGES_DIMS) {
            var pageInfo = this.PAGES_DIMS[i];
    ...
    PaperView.prototype.enabledTextSelectionListener = function () {
        var _this = this;
        document.onmousemove = function (e) {
            _this.mouse = { x: e.pageX, y: e.pageY };
        };
        this.viewport.onmouseup = function (e) {
            var selection = window.getSelection();
            var oRange = selection.getRangeAt(0); //get the text range
            var oRect = oRange.getBoundingClientRect();
            var pageNum = _this.getCurrentPageNum();
            var fromTop = _this.getPageTopDistFromTop(pageNum) - e.pageY;
            console.log(e.pageY);
            var commentEntry = {
                pageNum: pageNum,
                top: oRect.top,
                ...
                scrollPos: _this.getScrollPos(),
                viewportDimension: _this.VIEWPORT_DIM,
            };
...
Object.defineProperty(exports, "__esModule", { value: true });
var support_1 = __webpack_require__(2);
...
function embedComment(page, comment, newViewportHeight) {
    ...
    var scaledTopPos = (newViewportHeight * comment.top) / comment.viewportDimension.height;
    var paddingTopFix = scaledTopPos + element.offsetHeight;
